...
TOKEN = os.getenv('8738964867:AAF6uwcmXRImrVI91CEs_A4gCYxt36hhyi8') # Prefer .env
if not TOKEN or TOKEN == "8738964867:AAF6uwcmXRImrVI91CEs_A4gCYxt36hhyi8": # Check if token is missing or placeholder
